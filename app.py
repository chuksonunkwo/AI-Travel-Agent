...
def get_flight_links(org, dst, date_obj, flexible):
    ...
    if flexible:
        ...
        sky_link = f"https://www.skyscanner.com/transport/flights/{safe_org[:3]}/{safe_dst[:3]}/{month_str}{marker_str}"
    else:
        day_str = date_obj.strftime('%y%m%d')
        sky_link = f"https://www.skyscanner.com/transport/flights/{safe_org[:3]}/{safe_dst[:3]}/{day_str}{marker_str}"
